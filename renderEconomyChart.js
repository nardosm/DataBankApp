...
export default class RenderChart extends Component {
      ...
      switch(this.state.slider1ActiveSlide){
        ...
        case 0:
          return(
            ...
            <Text style={sty.chartTitle}><Icon name="ios-stats" size={20} color="#FB5260" /> {ENTRIES2[this.state.slider1ActiveSlide].title}</Text>
              <LineChart  data= {ENTRIES2[this.state.slider1ActiveSlide].data}/>
            </View>
          ) 
        break;
        ...
        case 1:
          return(
            <View style={{flex:3}}>
            <Text style={sty.chartTitle}><Icon name="ios-stats" size={20} color="#FB5260" />  {ENTRIES2[this.state.slider1ActiveSlide].title} </Text>
              <DoghnutChart  data= {ENTRIES2[this.state.slider1ActiveSlide].data}/>
            </View>
          ) 
        break;
        ...
        case 2:
          return(
            <View style={{flex:3}}>
            <Text style={sty.chartTitle}><Icon name="ios-stats" size={20} color="#FB5260" /> {ENTRIES2[this.state.slider1ActiveSlide].title} </Text>
              <BarChart  data= {ENTRIES2[this.state.slider1ActiveSlide].data}/>
            </View>
          ) 
        break;
        ...
        case 3:
          return(
            <View style={{flex:3}}>
            <Text style={sty.chartTitle}><Icon name="ios-stats" size={20} color="#FB5260" />  {ENTRIES2[this.state.slider1ActiveSlide].title} </Text>
              <PolarArea  data= {ENTRIES2[this.state.slider1ActiveSlide].data}/>
            </View>
          ) 
        break;
 ...
 render() {
  ...
  console.log("Chart data is :", ENTRIES2[0].data);
