...
export default class RenderChart extends Component {
    ...
    constructor (props) {
     ...
     fetchChartData0(indicatorValue,index) {
      ...
      fetch("http://api.worldbank.org/countries/"+this.props.countryCode+"/indicators/"+"NY.GDP.MKTP.KD.ZG"+"?format=json&date=2000:2016")
        .then((response) =>
          response.json())
        .then((responseData) => {
      ...
      fetch("http://api.worldbank.org/countries/"+this.props.countryCode+"/indicators/"+"NY.GNP.MKTP.KD.ZG"+"?format=json&date=2000:2016")
        .then((response) =>
          response.json())
        .then((responseData) => {
          //console.log(responseData)
      ...
      fetch("http://api.worldbank.org/countries/"+this.props.countryCode+"/indicators/"+ "NE.IMP.GNFS.KD.ZG"+"?format=json&date=2000:2016")
        .then((response) =>
          response.json())
        .then((responseData) => {
          //console.log(responseData)
      ...
      fetch("http://api.worldbank.org/countries/"+this.props.countryCode+"/indicators/"+"NV.IND.TOTL.KD.ZG"+"?format=json&date=2000:2016")
        .then((response) =>
          response.json())
        .then((responseData) => {
          //console.log(responseData)
  ...
  console.log("Chart3 data is :", this.state.chartData3);
    ...
    return (
              ...
              <LinearGradient colors={['#17303e', '#17303e']} style={styles.container}>
                  ...
                  <Text style={sty.subtext}>Economy at a Glance</Text>
