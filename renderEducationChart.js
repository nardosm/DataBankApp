...
export default class RenderChart extends Component {
    ...
    constructor (props) {
     ...
     fetchChartData0(indicatorValue,index) {
      ...
      fetch("http://api.worldbank.org/countries/"+this.props.countryCode+"/indicators/"+"SE.PRM.UNER.ZS"+"?format=json&date=2000:2016")
        .then((response) =>
          response.json())
        .then((responseData) => {
      ...
      fetch("http://api.worldbank.org/countries/"+this.props.countryCode+"/indicators/"+"SE.XPD.CPRM.ZS"+"?format=json&date=2000:2016")
        .then((response) =>
          response.json())
        .then((responseData) => {
          //console.log(responseData)
      ...
      fetch("http://api.worldbank.org/countries/"+this.props.countryCode+"/indicators/"+ "SE.TER.CUAT.BA.ZS"+"?format=json&date=2000:2016")
        .then((response) =>
          response.json())
        .then((responseData) => {
          //console.log(responseData)
      ...
      fetch("http://api.worldbank.org/countries/"+this.props.countryCode+"/indicators/"+"SE.SEC.ENRL"+"?format=json&date=2000:2016")
        .then((response) =>
          response.json())
        .then((responseData) => {
          //console.log(responseData)
